...
full_mds.dt[,`Survey Unit` := factor(`Survey Unit`, levels = c("W Coast S Island, NZ","SE US Summer","Scotian Shelf, CA"))]
...
draw_plot(x = 0, y = 0,mds_contrast, width = 3, height = 1) +
geom_text(x = 1.1, y = 1.05,aes(label = "Early year")) +
