...
gme_sne_overtime <- ggplot(data = reduced_1_3, aes(x = YEAR, y = jaccard_dissimilarity)) +
  ...
  geom_smooth(method = "lm", se = F) +
  ylim(0.45,0.85) +
  stat_cor(label.y = 0.7, label.x = 1970, size = 8) +
  stat_regline_equation(label.y = 0.75, label.x = 1970, size = 8) +
  labs(x= "Year", y = "Jaccard Dissimilarity") +
  ggtitle("GME vs. SNE") +
  theme_classic() +
  theme(text = element_text(size = 25), plot.margin = margin(10, 20, 10, 10))
...
geo_sne_overtime <- ggplot(data = reduced_3_2, aes(x = YEAR, y = jaccard_dissimilarity)) +
  ...
  geom_smooth(method = "lm", se = F) +
  ylim(0.25,0.6) +
  stat_cor(label.y = 0.3, label.x = 1980, size = 8) +
  stat_regline_equation(label.y = 0.35, label.x = 1980, size = 8) +
  labs(x= "Year", y = "Jaccard Dissimilarity") +
  ggtitle("GEO vs. SNE") +
  theme_classic() +
  theme(text = element_text(size = 25), plot.margin = margin(10, 20, 10, 10))
...
sne_mab_overtime <- ggplot(data = reduced_3_4, aes(x = YEAR, y = jaccard_dissimilarity)) +
  ...
  geom_smooth(method = "lm", se = F) +
  ylim(0.4,0.8) +
  stat_cor(label.y = 0.7, label.x = 1990, size = 8) +
  stat_regline_equation(label.y = 0.75, label.x = 1990, size = 8) +
  labs(x= "Year", y = "Jaccard Dissimilarity") +
  ggtitle("SNE vs. MAB") +
  theme_classic() +
  theme(text = element_text(size = 25), plot.margin = margin(10, 20, 10, 10))
