...
FishGlob.10year.spp_manualclean[,num := my_mean(num),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,wgt := my_mean(wgt),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,num_cpue := my_mean(num_cpue),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,num_h := my_mean(num_h),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,wgt_cpue := my_mean(wgt_cpue),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,wgt_h := my_mean(wgt_h),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)]
FishGlob.10year.spp_manualclean[,depth := my_mean(depth),.(survey_unit, year, month, day, verbatim_name, accepted_name, latitude, longitude)] #also, depth needs to be converted from character to numeric
