...
load("data/FishGlob_wgt_abun_edits/AI_clean.RData")
AI_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/EBS_clean.RData")
EBS_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/GMEX_clean.RData")
GMEX_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/GOA_clean.RData")
GOA_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/NEUS_clean.RData")
NEUS_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/QCS_clean.RData")
QCS_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/SCS_clean.RData")
SCS_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/SEUS_clean.RData")
SEUS_clean <- data.table(data)
load("data/FishGlob_wgt_abun_edits/WCANN_clean.RData")
