...
ebs_merge <- plot_grid(ebs_jaccard_heatmap + theme(legend.position = "none", axis.title.x = element_blank(), axis.text.x = element_blank()) , ebs_bray_heatmap + theme(legend.position = "none", axis.title.x = element_blank(), axis.text.x = element_blank()), ebs_legend_heatmaps, ebs_jaccard_boxplot, ebs_bray_boxplot,  nrow = 2, ncol = 3, align = "hv", axis = "lb")
