...
neus_data <- readRDS("/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/data/gridded/USA-NEUS/neus_data_gridded.RData")

#distance among grid cells

neus_distances.l <- readRDS("/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/neus_reg_distances.l.RData")

neus_distances <- readRDS("/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/neus_reg_distances.RData")

neus_grid_cells <- readRDS("/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/neus_grid_cells.RData")
...
#bray total (nestedness and turnover)  
  #bray balanced (turnover)
  fit_bray_total <- decay.model(1-beta.pair.abund$beta.bray.bal, distances, model.type = "exp", y.type = "sim") # 1 minus because output of betadist object gives us dissimilarity
...
#    fit_jaccard$b.slope = rate at which similarity decreases with distance in a neg exponential model
  ...
  #total jaccard from pres abs data
    fit_total_jaccard <- decay.model(1-beta.pair$beta.jtu, distances, y.type = "similarities", model.type = "exp") #beta.jtu dissimilarity matrix accounting for spatial total, measured as the totalfraction of Jaccard pair-wise dissimilarity
