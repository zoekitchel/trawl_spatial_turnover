...
ggsave(path = here::here("figures","neus"), filename = "neus_bothseasons_jaccard_halvingdistance.jpg")
```
Both Bray together
...
ggsave(path = here::here("figures","neus"), filename = "neus_bothseasons_bray_halvingdistance.jpg")
```
...
ggsave(path = here::here("figures","neus"), filename = "neus_bothseasons_jaccard_initialdistance.jpg")
```
...
ggsave(path = here::here("figures","neus"), filename = "neus_bothseasons_bray_initialdistance.jpg")
```