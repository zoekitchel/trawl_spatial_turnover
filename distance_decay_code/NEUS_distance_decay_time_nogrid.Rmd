...
neus_similarity_mod_coefs <- data.table("year" = neus_years_spring,
                                        "jaccard_total_intercept" = 0,"jaccard_total_intercept_se"=0,
                                        "jaccard_total_slope" = 0, "jaccard_total_slope_se" = 0,
                                        "jaccard_turnover_intercept" = 0, "jaccard_turnover_intercept_se" = 0,
                                        "jaccard_turnover_slope" = 0, "jaccard_turnover_slope_se" = 0,
                                        "bray_total_intercept" = 0,"bray_total_intercept_se" = 0,
                                        "bray_total_slope" = 0, "bray_total_slope_se" = 0,
                                        "bray_balanced_intercept" = 0, "bray_balanced_intercept_se" = 0,
                                        "bray_balanced_slope" = 0, "bray_balanced_slope_se" = 0)
...
for (i in 1:length(neus_years_spring)) {
  ...
  for (j in 1:nrow(lat_lon_haulid)){ #jackknife
    
    #pull out one haul id per run
...
#bray total (nestedness and turnover)  
  ...
  g = suppressWarnings(glm(s~d,family=binomial(link='log')))
    ...
    Summary_jaccardturnover=rbind(apply(Results_jaccardturnover,2,mean),
      ...
      neus_similarity_mod_coefs[i,"jaccard_total_a_intercept"] <- Summary_jaccardtotal[1,1]
      neus_similarity_mod_coefs[i,"jaccard_total_beta_slope"] <- Summary_jaccardtotal[1,2]
      neus_similarity_mod_coefs[i, "jaccard_turnover_a_intercept"] <- Summary_jaccardturnover[1,1] 
      neus_similarity_mod_coefs[i, "jaccard_turnover_beta_slope"] <- Summary_jaccardturnover[1,2] 
      neus_similarity_mod_coefs[i, "bray_total_a_intercept"] <- Summary_braytotal[1,1] 
      neus_similarity_mod_coefs[i, "bray_total_beta_slope"] <- Summary_braytotal[1,2] 
      neus_similarity_mod_coefs[i, "bray_balanced_a_intercept"] <- Summary_braybalanced[1,1] 
      neus_similarity_mod_coefs[i, "bray_balanced_beta_slope"] <- Summary_braybalanced[1,2] 
      
      neus_similarity_mod_coefs[i,"jaccard_total_initial"] <- Summary_jaccardtotal[1,3]
      neus_similarity_mod_coefs[i,"jaccard_total_halving"] <- Summary_jaccardtotal[1,4]
      neus_similarity_mod_coefs[i, "jaccard_turnover_initial"] <- Summary_jaccardturnover[1,3] 
      neus_similarity_mod_coefs[i, "jaccard_turnover_halving"] <- Summary_jaccardturnover[1,4] 
      neus_similarity_mod_coefs[i, "bray_total_initial"] <- Summary_braytotal[1,3] 
      neus_similarity_mod_coefs[i, "bray_total_halving"] <- Summary_braytotal[1,4] 
      neus_similarity_mod_coefs[i, "bray_balanced_initial"] <- Summary_braybalanced[1,3] 
      neus_similarity_mod_coefs[i, "bray_balanced_halving"] <- Summary_braybalanced[1,4] 
      
      #standard error
      neus_similarity_mod_coefs[i,"jaccard_total_intercept_se"] <- Summary_jaccardtotal[2,1]
      neus_similarity_mod_coefs[i,"jaccard_total_slope_se"] <- Summary_jaccardtotal[2,2]
      neus_similarity_mod_coefs[i, "jaccard_turnover_intercept_se"] <- Summary_jaccardturnover[2,1] 
      neus_similarity_mod_coefs[i, "jaccard_turnover_slope_se"] <- Summary_jaccardturnover[2,2] 
      neus_similarity_mod_coefs[i, "bray_total_intercept_se"] <- Summary_braytotal[2,1] 
      neus_similarity_mod_coefs[i, "bray_total_slope_se"] <- Summary_braytotal[2,2] 
      neus_similarity_mod_coefs[i, "bray_balanced_intercept_se"] <- Summary_braybalanced[2,1] 
      neus_similarity_mod_coefs[i, "bray_balanced_slope_se"] <- Summary_braybalanced[2,2] 
      
      neus_similarity_mod_coefs[i,"jaccard_total_initial_se"] <- Summary_jaccardtotal[2,3]
      neus_similarity_mod_coefs[i,"jaccard_total_halving_se"] <- Summary_jaccardtotal[2,4]
      neus_similarity_mod_coefs[i, "jaccard_turnover_initial_se"] <- Summary_jaccardturnover[2,3] 
      neus_similarity_mod_coefs[i, "jaccard_turnover_halving_se"] <- Summary_jaccardturnover[2,4] 
      neus_similarity_mod_coefs[i, "bray_total_initial_se"] <- Summary_braytotal[2,3] 
      neus_similarity_mod_coefs[i, "bray_total_halving_se"] <- Summary_braytotal[2,4] 
      neus_similarity_mod_coefs[i, "bray_balanced_initial_se"] <- Summary_braybalanced[2,3] 
      neus_similarity_mod_coefs[i, "bray_balanced_halving_se"] <- Summary_braybalanced[2,4] 
      
    
      print(paste0(i,"/",length(neus_years_spring)))
}

save(neus_similarity_mod_coefs, file = "neus_similarity_mod_coefs.RData")
#load("neus_similarity_mod_coefs.RData")
