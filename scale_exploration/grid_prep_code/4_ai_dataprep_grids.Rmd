...
geom_polygon(data = north_america, 
                                 ...
                                 fill = "white", 
                                 color="black") +
    coord_fixed(xlim = c(-200, -140),  ylim = c(50, 80), ratio = 1.3) +
...
unique_ai_latlon[,cell := dgGEO_to_SEQNUM(dggs, longitude, latitude)] #get corresponding grid cells for NEUS trawl
...
ai <- merge(ai, unique_ai_latlon, by = c("latitude", "longitude"))
...
grid_ai <- merge(grid_ai, unique_ai_latlon, by= "cell")
