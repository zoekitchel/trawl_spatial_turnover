...
grid_ai <- merge(grid_ai, unique_ai_latlon, by.x = "cell", by.y ="cell")

ggplot(data = grid_ai, aes(x = long, y = lat.x, group = cell)) +
  geom_polygon() +
  coord_quickmap()
...
na_outline + 
   geom_polygon(grid_ai, mapping = aes(x = long,y = lat.x, group = cell), inherit.aes = FALSE, color = "black", fill = NA, size = 0.1)
