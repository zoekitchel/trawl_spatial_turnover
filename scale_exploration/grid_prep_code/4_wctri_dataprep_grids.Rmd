...
dat_WCTRI$spp <- gsub("Astropecten verilli", "Astropecten verrilli", dat_WCTRI$spp) #won't come up for some reason, ignore for now
dat_WCTRI$spp <- gsub("Chrysaora fuscens", "Chrysaora fuscescens", dat_WCTRI$spp)
...
summary(wctri_unique_tows_cell[,.N,.(year,cell)]$N < 3) #this occurs in 14/309 cell/year combos  (4.5%, no biggie)
