...
saveRDS(dat_NEUS, "/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/dat_NEUS.RData")
#if we need to load, unhash
#dat_NEUS <- readRDS("/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/trawl_spatial_turnover/dat_NEUS.RData")
...
saveRDS(unique_neus_latlon, "unique_neus_latlon.RData") #save list of lat lon coordinates
...
dat_NEUS_grid.spring.reduced <- dat_NEUS_grid.clean[!cell %in% dump_spring][region == "Northeast US Spring",]
dat_NEUS_grid.fall.reduced <- dat_NEUS_grid.clean[!cell %in% dump_fall][region == "Northeast US Fall",]
...
summary(neus_fall_unique_tows_cell[,.N,.(year,cell)]$N < 3) #for fall, this occurs in 131/1781 (7%) year, cell combos
summary(neus_spring_unique_tows_cell[,.N,.(year,cell)]$N < 3) #for spring this occurs in 243/1881 (13%) cases, year, cell combos
