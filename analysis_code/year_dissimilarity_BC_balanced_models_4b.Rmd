...
nname_helper <- data.table(Survey_Name_Season = c("Aleutian Islands",
                                    "Baltic Sea Q1",
                                    "Baltic Sea Q4",
                                    "Chile",
                                    "Newfoundland",
...
BC_BALANCED_Dissimilarity_Coef_errorbar_reduced <- ggplot() +
  ...
  coord_flip() +
  theme_classic() +
  theme(axis.text.y = element_text(face = "bold"), axis.title.y = element_blank(), axis.text.x = element_text(size = 15), axis.title.x = element_text(size = 15), legend.position = "top")
...
#all survey names = 
all_survey_names <- sort(unique(FishGlob_clean.noNA$Survey_Name_Season))
#list of plots
    ...
    draw_plot(get_legend(directional_change_legend_plot + 
      theme(legend.key.size = unit(0.5, 'cm'), #change legend key size
        ...
        legend.text = element_text(size=12))), #change legend text font size)
                                       x = 35, y = 4, width = 3, height = 2) +
  geom_text(aes(x = 2, y = 19.7), label = ("a."), size =8, fontface = "bold") +
  geom_text(aes(x =21, y = 19.7), label = ("b."), size =8, fontface = "bold")
...
#ALT GREY SCALE
BC_BALANCED_GAM_LMER_merge_legend_greyscale <- ggdraw(xlim = c(0, 40), ylim = c(0, 20)) +
