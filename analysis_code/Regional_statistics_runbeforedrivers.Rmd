...
```{r}
Fishglob_gamma_beta <- FishGlob_richness_year_survey[dissimilarities_temp_fishing, on = c("survey_unit","year")]
...
Excludes ZAF_IND, Nor-BTS-3, MEDITS, ICE-GFS, GSL-S, GOA for now
```{r mean_temp}
