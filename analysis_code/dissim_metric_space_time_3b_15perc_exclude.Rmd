...
FishGlob_clean_15perc_excluded <- name_helper[FishGlob_clean.noNA_15perc_excluded, on = "survey_unit"]
saveRDS(FishGlob_clean.noNA_15perc_excluded, here::here("output","FishGlob_clean.noNA_15perc_excluded.Rds"))
```

Survey Statistics for all regions (maybe delete? or pull from original 3?)
```{r}
