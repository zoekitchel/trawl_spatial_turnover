...
BC_BALANCED_Dissimilarity_Coef_errorbar_reduced <- ggplot() +
  ...
  xlab("Survey unit") +
  ylab("Balanced BC dissimilarity trend") +
  coord_flip() +
  theme_classic() +
...
ggsave(points_wavylines_bray_balanced_year_reduced_gam, path = here::here("figures"), filename ="points_wavylines_bray_balanced_year_reduced_gam.jpg", height = 5, width = 5, unit = "in")
...
BC_BALANCED_GAM_LMER_merge <- plot_grid(points_wavylines_bray_balanced_year_reduced_gam + theme(legend.position = "none", plot.margin = margin(2,0,0,0, unit = "cm")), BC_BALANCED_Dissimilarity_Coef_errorbar_reduced + theme(legend.position = "none", plot.margin = margin(2,0,0,0, unit = "cm")), labels = c("","Survey Unit  ",""), vjust = 1.5, hjust = 0)

BC_BALANCED_GAM_LMER_merge_legend <- plot_grid(BC_BALANCED_GAM_LMER_merge, get_legend(BC_BALANCED_Dissimilarity_Coef_errorbar_reduced), rel_widths = c(10,2))

ggsave(BC_BALANCED_GAM_LMER_merge_legend, path = here::here("figures"), filename = "BC_BALANCED_GAM_LMER_merge_legend.png", height = 7, width = 14, units = "in")
```
```
