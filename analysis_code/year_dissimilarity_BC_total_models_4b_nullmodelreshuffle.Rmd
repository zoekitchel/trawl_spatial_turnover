...
true_slopes <- data.table(run = "observed",differentiating = sum(bray_curtis_total_coefs.r_true$differentiating == "Differentiation"), homogenizing = sum(bray_curtis_total_coefs.r_true$homogenizing))
