...
BC_gradient_model_coefs_reduced_length.unique.alpha[,trend_color := ifelse(Directional_Change_sig == "Homogenization", "#e7ac5b", ifelse(Directional_Change_sig == "Differentiation","#91c874","#75608a"))]
...
#       y = c(0,0.5)) +
    #add year breaks
  scale_x_continuous(breaks = seq(min(distances_dissimilarities_allyears.r[Survey_Name_Season == all_survey_names[i]]$year),max(distances_dissimilarities_allyears.r[Survey_Name_Season == all_survey_names[i]]$year), by = 5)) +
  xlab("Year") +
ylab("beta-diversity") +
