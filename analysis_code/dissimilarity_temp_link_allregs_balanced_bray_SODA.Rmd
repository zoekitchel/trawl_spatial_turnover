...
scaled_dissim_scaled_mods_AICc <- AICc(dissimilarity_BC_balanced_sbt_maxSD_scaled_dissim_scaled_mod , dissimilarity_BC_balanced_sbt_meanSD_scaled_dissim_scaled_mod,
dissimilarity_BC_balanced_sbt_max_scaled_dissim_scaled_mod  ,  dissimilarity_BC_balanced_sbt_minSD_scaled_dissim_scaled_mod, 
dissimilarity_BC_balanced_sbt_seas_scaled_dissim_scaled_mod ,  dissimilarity_BC_balanced_sbt_seasSD_scaled_dissim_scaled_mod,
dissimilarity_BC_balanced_sbt_min_scaled_dissim_scaled_mod  ,  dissimilarity_BC_balanced_sbt_mean_scaled_dissim_scaled_mod) #compare all scaled_mods

#best mods (all within 2 AICc): 
r.squaredGLMM(dissimilarity_BC_balanced_sbt_min_scaled_dissim_scaled_mod)
summary(dissimilarity_BC_balanced_sbt_min_scaled_dissim_scaled_mod) #p = 0.06
r.squaredGLMM(dissimilarity_BC_balanced_sbt_mean_scaled_dissim_scaled_mod)
summary(dissimilarity_BC_balanced_sbt_mean_scaled_dissim_scaled_mod)# 0.09
r.squaredGLMM(dissimilarity_BC_balanced_sbt_maxSD_scaled_dissim_scaled_mod)
summary(dissimilarity_BC_balanced_sbt_maxSD_scaled_dissim_scaled_mod) # p = 0.168
...
ggsave(dissimilarity_BC_balanced_sbt_mean.final, path  = here::here("figures","distance_decay"), filename = "dissimilarity_BC_balanced_sbt_mean.final.jpg", height = 4, width = 9, unit = "in") 
...
ggsave(dissimilarity_BC_balanced_sbt_mean_facet.final, path  = here::here("figures","distance_decay"), filename = "dissimilarity_BC_balanced_sbt_mean_facet.final.jpg", height = 10, width = 16, unit = "in")
```
...
ggsave(dissimilarity_BC_balanced_sbt_mean.s.final, path  = here::here("figures","distance_decay"), filename = "dissimilarity_BC_balanced_sbt_mean.s.final.jpg", height = 4, width = 9, unit = "in") 
...
ggsave(dissimilarity_BC_balanced_sbt_mean_facet.s.final, path  = here::here("figures","distance_decay"), filename = "dissimilarity_BC_balanced_sbt_mean_facet.s.final.jpg", height = 10, width = 16, unit = "in")
```
