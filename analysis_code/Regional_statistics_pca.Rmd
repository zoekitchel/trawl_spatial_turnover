...
spp_num_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = spp_num, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = spp_num , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = spp_num , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Gamma Diversity of Survey Unit") +
  coord_flip() +
  theme_classic()

spp_num_vs_coef

ggsave(spp_num_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "spp_num_vs_coef.jpg", height =7, width = 5, unit = "in")
...
study_period_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = study_period, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = study_period , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = study_period , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Survey Period (First-Last)") +
  coord_flip() +
  theme_classic()

study_period_vs_coef

ggsave(study_period_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "study_period_vs_coef.jpg", height =7, width = 5, unit = "in")
```
...
study_duration_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = study_duration, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = study_duration , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = study_duration , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Total Years Sampled") +
  coord_flip() +
  theme_classic()

study_duration_vs_coef

ggsave(study_duration_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "study_duration_vs_coef.jpg", height =7, width = 5, unit = "in")
```
...
lat_range_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = lat_range, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5, position = "jitter") + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = lat_range , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1, position = "jitter") +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = lat_range , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1, position = "jitter") +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
...
ggsave(lat_range_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "lat_range_vs_coef.jpg", height =7, width = 5, unit = "in")
```
...
mid_lat_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = mid_lat, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = mid_lat , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = mid_lat , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Latitude") +
...
ggsave(mid_lat_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "mid_lat_vs_coef.jpg", height =7, width = 5, unit = "in")
```
...
```{r area}
#note two largest surveys are Norway and MEDITS
area_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = area_km, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = area_km , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = area_km , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Study Area (km^2)") +
  coord_flip() +
  theme_classic()

area_vs_coef

ggsave(area_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "area_vs_coef.jpg", height =7, width = 5, unit = "in")

```

```{r number of hauls vs area}
#note high value is SEUS summer survey
avg_hauls_area_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = avg_hauls_area, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = avg_hauls_area , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = avg_hauls_area , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Avg Annual Hauls per Area (km^2)") +
  coord_flip() +
  theme_classic()

avg_hauls_area_vs_coef

ggsave(avg_hauls_area_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "avg_hauls_area_vs_coef.jpg", height =7, width = 5, unit = "in")
```
...
depth_range_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = depth_range, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = depth_range , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = depth_range , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Depth Range (m)") +
...
ggsave(depth_range_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "depth_range_vs_coef.jpg", height =7, width = 5, unit = "in")
```

```{r mid_depth}

mid_depth_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = mid_depth, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = mid_depth , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = mid_depth , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab("Average Sampling Depth (m)") +
  coord_flip() +
  theme_classic()

mid_depth_vs_coef

ggsave(mid_depth_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "mid_depth_vs_coef.jpg", height =7, width = 5, unit = "in")
```

```{r mean_temp}
mean_temp_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = mean_temp, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = mean_temp , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = mean_temp , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab(paste0("Mean Temperature (","\u00B0"," C)")) +
  coord_flip() +
  theme_classic()

mean_temp_vs_coef

ggsave(mean_temp_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "mean_temp_vs_coef.jpg", height =7, width = 5, unit = "in")
```

```{r mean_landings}

mean_landings_vs_coef <- ggplot() +
    geom_errorbar(data = region_stats, aes(x = mean_landings, y = bray_coef, ymin = bray_coef_lwr, ymax = bray_coef_upr), color = "grey", alpha = 0.8, width = 0.5) + #add confidence intervals
    geom_point(data = region_stats[`Significant Trends` == "No Directional Change",], aes(x = mean_landings , y = bray_coef), stat = 'identity', fill = "grey",color = "grey", shape = 21, size = 1) +
        geom_point(data = region_stats[`Significant Trends` != "No Directional Change",], aes(x = mean_landings , y = bray_coef, fill = Directional_Change), stat = 'identity', shape = 21, color = "black", size = 1) +
    scale_fill_manual(values = c("white","black"), name = "Directional Change") +
  geom_hline(yintercept = 0, size = 0.5) +
  ylab("Coefficient Dissimilarity ~ Year") +
  xlab(paste0("Average Annual Landings (tonnes)")) +
  coord_flip() +
  theme_classic()

mean_landings_vs_coef

ggsave(mean_landings_vs_coef, path = here::here("figures","bray_coef_vs_survey_characteristics"), filename = "mean_landings_vs_coef.jpg", height =7, width = 5, unit = "in")
```
