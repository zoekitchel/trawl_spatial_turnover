...
#merge
bray_curtis_fishing_SSTtemp_model_observed_predicted_merge <- plot_grid(bray_curtis_fishing_temp_model_observed_predicted + theme(plot.margin = unit(c(0.1,0.3,0.1,0.1),"cm")),
...
ggsave(bray_curtis_fishing_SSTtemp_model_observed_predicted_merge, path = here::here("figures"),filename = "bray_curtis_fishing_SSTtemp_model_observed_predicted_merge.jpg", height =6, width = 8)
