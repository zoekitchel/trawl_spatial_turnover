...
bray_curtis_total_coefs <- data.table(summary(bray_curtis_total_lm)$coefficients)
  ...
  bray_curtis_total_coefs.r <- bray_curtis_total_coefs[c(2,24:44),]
  ...
  bray_curtis_total_coefs.r[2:22,survey_unit_coefficient := (AI_estimate + Estimate)]
...
bray_curtis_total_relative_coefs <- data.table(summary(bray_curtis_total_relative_lm)$coefficients)
  ...
  #limit to interactions only (check this if there are any model changes!) row 2 and rows 24:44
  bray_curtis_total_relative_coefs.r <- bray_curtis_total_relative_coefs[c(2,24:44),]
  ...
  bray_curtis_total_relative_coefs.r[2:22,survey_unit_coefficient := (AI_estimate + Estimate)]
...
AICc(jaccard_total_gls)-AICc(jaccard_total_lm) #397.0673
