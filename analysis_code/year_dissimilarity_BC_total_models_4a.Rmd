---
title: "Year Total BC Dissimilarity Models"
output: html_notebook
---

This code is Script 4 va for Kitchel et al. TITLE manuscript.
...
BC_total_model_coefs_reduced_length.unique <- unique(model_coefs_reduced_length[,.(condval,condsd, lwr, upr, survey_unit, year_adj, years_sampled, Directional_Change, hex, Survey_Name_Season, significant)]) 
...
BC_total_GAM_LMER_merge_legend <- ggdraw(xlim = c(0, 40), ylim = c(0, 20)) +
