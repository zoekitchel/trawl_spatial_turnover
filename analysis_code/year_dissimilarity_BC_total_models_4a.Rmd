...
bray_curtis_total_coefs <- data.table(summary(bray_curtis_total_lm)$coefficients)
  ...
  #hex by trend
  bray_curtis_total_coefs.r[,trend_color := ifelse(homogenizing == 1, "#D81C60", ifelse(differentiating == 1,"#FFC109","#1E88E5"))]
...
jaccard_total_coefs <- data.table(summary(jaccard_total_lm)$coefficients)
  ...
  #hex by trend
  jaccard_total_coefs.r[,trend_color_jaccard := ifelse(homogenizing == 1, "#D81C60", ifelse(differentiating == 1,"#FFC109","#1E88E5"))]
...
bray_curtis_balanced_coefs <- data.table(summary(bray_curtis_balanced_lm)$coefficients)
  ...
  #hex by trend
  bray_curtis_balanced_coefs.r[,trend_color_bray_curtis_balanced := ifelse(homogenizing == 1, "#D81C60", ifelse(differentiating == 1,"#FFC109","#1E88E5"))]
...
bray_curtis_gradient_coefs <- data.table(summary(bray_curtis_gradient_lm)$coefficients)
  ...
  #hex by trend
  bray_curtis_gradient_coefs.r[,trend_color_bray_curtis_gradient := ifelse(homogenizing == 1, "#D81C60", ifelse(differentiating == 1,"#FFC109","#1E88E5"))]
