...
bray_curtis_total_coefs <- data.table(summary(bray_curtis_total_lm)$coefficients)
  ...
  #hex by trend
  bray_curtis_total_coefs_onethirdyears_exclude.r[,trend_color := ifelse(homogenizing == 1, "#e7ac5b", ifelse(differentiating == 1,"#91c874","#75608a"))]
...
points_wavylines_bray_total_year_reduced_gam_colorbytrend_onethirdyears_exclude <- ggplot() +
  ...
  theme_classic() +
        #add year breaks
  scale_x_continuous(breaks = c(1968,1980,1990,2000,2010,2022), limits = c(1968,2025)) +
  xlab("Year") +
ylab("β-diversity") +
