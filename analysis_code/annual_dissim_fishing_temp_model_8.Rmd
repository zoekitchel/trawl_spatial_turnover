...
---
title: "Model annual dissimilarity with temperature, fishing, and survey identity (trialing survey as random effect with fixed interaction instead of fully fixed parameter)"
...
*trialing survey as random effect with fixed interaction instead of fully fixed parameter
...
###Pull in area and add to dissimilarity data table
```{r}
...
###Pull in season/Julian day and add to dissimilarity data table
```{r}
#load up julian days
...
###Set up dredge by making data table of covariates
```{r}
...
###Full global model (with survey or year & survey as random intercepts)
...
-SD (scaled across all regions)

Comparing temperature variables, and models with and without acknowledging temporal autocorrelation with a random intercept for year
```{r fit global mod}
#sort surveys
dissimilarity_covariates_dredge.dt[, survey_unit := factor(survey_unit, levels = sort(all_surveys))]

#mean temperature, random survey
global_mod_mean_temp_lmer_random_survey <- lmer(annual_dissimilarity_value ~ 
                             ...
                             season + (1|survey_unit),
                             data = dissimilarity_covariates_dredge.dt)

#mean temperature, random survey and year
global_mod_mean_temp_lmer_random_surveyyear <- lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_mean_bypoint_avg.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_mean_bypoint_avg.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
                             ...
                             spp_count_annual.scaledacrossall + #spp #
                             haul_id_count_annual.scaledacrossall +
                            season + (1|survey_unit) + (1|year),
                             data = dissimilarity_covariates_dredge.dt)

#maximum temperature, random survey
global_mod_max_temp_lmer_random_survey <- lmer(annual_dissimilarity_value ~ 
...
#maximum temperature, random survey and year
global_mod_max_temp_lmer_random_surveyyear <-lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_max_bypoint_avg.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_max_bypoint_avg.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
...
#minimum temperature, random survey
global_mod_min_temp_lmer_random_survey <- lmer(annual_dissimilarity_value ~ 
...
#minimum temperature, random survey and year
global_mod_min_temp_lmer_random_surveyyear <-lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_min_bypoint_avg.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_min_bypoint_avg.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
...
#temperature seasonality, random survey
global_mod_seas_temp_lmer_random_survey <- lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_seas_bypoint_avg.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_seas_bypoint_avg.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
                             area_km.scaledacrossall + #area
                             latitude_annual_range.scaledacrossall + #latitude range
...
#temperature seasonality, random survey and year
global_mod_seas_temp_lmer_random_surveyyear <- lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_seas_bypoint_avg.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_seas_bypoint_avg.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
...
#SD of temperature across space, random survey
global_mod_SD_temp_lmer_random_survey <- lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_mean_bypoint_SD.scaledacrossall + #temp and survey unit (possible interaction)
                              yearly_mean_bypoint_SD.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                              summed_tonnes_scaled_byreg +
                             area_km.scaledacrossall + #area
                             latitude_annual_range.scaledacrossall + #latitude range
...
#SD of temperature across space, random survey and year
global_mod_SD_temp_lmer_random_surveyyear <- lmer(annual_dissimilarity_value ~ 
                             survey_unit:yearly_mean_bypoint_SD.scaledacrossall + #temp and survey unit (possible interaction)
                               yearly_mean_bypoint_SD.scaledacrossall +
                             survey_unit:summed_tonnes_scaled_byreg + #fishing effort and survey unit (possible interaction)
                               summed_tonnes_scaled_byreg +
...
View(AICc(global_mod_mean_temp_lmer_random_survey, global_mod_max_temp_lmer_random_survey, global_mod_min_temp_lmer_random_survey, global_mod_seas_temp_lmer_random_survey, global_mod_SD_temp_lmer_random_survey,
          global_mod_mean_temp_lmer_random_surveyyear, global_mod_max_temp_lmer_random_surveyyear, global_mod_min_temp_lmer_random_surveyyear, global_mod_seas_temp_lmer_random_surveyyear, global_mod_SD_temp_lmer_random_surveyyear))
...
global_mod_temp_table <- data.table(
  ...
  `Temperature variable` = rep(c(                  
              ...
              "SBT SD"),2),
  deltaAICc = signif(min(AICc(global_mod_mean_temp_lmer_random_survey, global_mod_max_temp_lmer_random_survey, global_mod_min_temp_lmer_random_survey, global_mod_seas_temp_lmer_random_survey, global_mod_SD_temp_lmer_random_survey,
          global_mod_mean_temp_lmer_random_surveyyear, global_mod_max_temp_lmer_random_surveyyear, global_mod_min_temp_lmer_random_surveyyear, global_mod_seas_temp_lmer_random_surveyyear, global_mod_SD_temp_lmer_random_surveyyear)[,2])-AICc(global_mod_mean_temp_lmer_random_survey, global_mod_max_temp_lmer_random_survey, global_mod_min_temp_lmer_random_survey, global_mod_seas_temp_lmer_random_survey, global_mod_SD_temp_lmer_random_survey,
          global_mod_mean_temp_lmer_random_surveyyear, global_mod_max_temp_lmer_random_surveyyear, global_mod_min_temp_lmer_random_surveyyear, global_mod_seas_temp_lmer_random_surveyyear, global_mod_SD_temp_lmer_random_surveyyear)[,2],2))
...
Best performing global model includes minimum temperature (centered and scaled) and no temporal autocorrelation (Still the case as of July 17, 2024)
...
dd <- dredge(global_mod_min_temp_lmer_random_survey)
dd.dt <- data.table(dd)
View(dd)
...
r_squaredm_values <-list()
r_squaredc_values <-list()
for (i in 1:nrow(dd.dt.2.formatted)) {
  r_squared <- signif(r.squaredGLMM(get.models(dd, subset = i)[[1]]))
  #marginal (only fixed effects)
  r_squaredm <- r_squared[,1]
  #conditional (with random intercept for survey)
  r_squaredc <- r_squared[,2]
  
  #merge marginal
  r_squaredm_values <- unlist(c(r_squaredm_values,r_squaredm))
  #merge conditional
  r_squaredc_values <- unlist(c(r_squaredc_values,r_squaredc))
}

#add to data table of top models
dd.dt.2.formatted[,"R squared marginal" := r_squaredm_values]
dd.dt.2.formatted[,"R squared conditional" := r_squaredc_values]

#make empty data table to population with coefficients and standard errors
...
#model average all models with delta < 4 (4 models)
