...
interaction_avg_model_coef <- model_avg_values[c(4,36:98),.(coef_name, coef, se)]
...
```{r}
model_avg_values.nonfishortemp <- model_avg_values[c(2,3,99:103),]
...
model_avg_values.nonfishortemp[,Variable := c("Area","Species count","Number of tows","Latitude range","Depth","Latitude","Depth range")]
