...
OISST_data_temp_avgs_full[, year := as.numeric(as.character(year))][, survey_unit := as.character(survey_unit)][,season := NULL][,survey := NULL]
...
#fishing
distances_dissimilarities_allyears.r.temp.fishing <- SAU_summed_tonnes.r[distances_dissimilarities_allyears.r.temp, on = c("year", "survey_unit")]

#save avg values
saveRDS(distances_dissimilarities_allyears.r.temp.fishing, here::here("output","distance_decay","distances_dissimilarities_allyears.r.temp.fishing.rds"))
```
...
#fishing over time
ebs_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS",]) +
  geom_point(aes(x = year, y = summed_tonnes), color  = "#325A9B") +
  labs(x = "Year",  y = "Total Landings (tonnes)") +
  theme_classic()

#for just EBS
(ebs_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS",]) +
...
ebs_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS",])
...
```{r temp all regions}
#for all regions
(allreg_dissimilarity_fishing_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing) +
...
(allreg_dissimilarity_fishing_mean_SIMPLIFIED <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing) +
...
allreg_dissimilarity_fishing_mean_mod <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

#no random effect for survey
allreg_dissimilarity_fishing_mean_mod_lm <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg, data = distances_dissimilarities_allyears.r.temp.fishing)
...
allreg_dissimilarity_fishing_temp_mod_1 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg*sst_min_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

  #what if we delete interaction? 
  allreg_dissimilarity_fishing_temp_mod_1.1 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg + sst_min_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

allreg_dissimilarity_fishing_temp_mod_2 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg*sst_max_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

allreg_dissimilarity_fishing_temp_mod_3 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg*sst_mean_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

allreg_dissimilarity_fishing_temp_mod_4 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg*sst_seas_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

allreg_dissimilarity_fishing_temp_mod_5 <- lmer(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes_scaled_byreg*sst_SD_scaled + (1|survey_unit), data = distances_dissimilarities_allyears.r.temp.fishing)

AICc(allreg_dissimilarity_fishing_temp_mod_1, allreg_dissimilarity_fishing_temp_mod_2,allreg_dissimilarity_fishing_temp_mod_3,allreg_dissimilarity_fishing_temp_mod_4,allreg_dissimilarity_fishing_temp_mod_5)

AICc(allreg_dissimilarity_fishing_temp_mod_1, allreg_dissimilarity_fishing_temp_mod_1.1)
...
interact_plot(allreg_dissimilarity_fishing_temp_mod_SDonly, pred = sst_SD_scaled, modx = summed_tonnes_scaled, plot.points = T, colors = c("#b3ffe4","#00d68b","#003d28"), x.label = "Spatial Standard Deviation\nof Sea Surface Temperature \n Scaled within Region", y.label = "Mean Annual Bray Curtis Dissimilarity") + theme_classic()
...
EBS_dissimilarity_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
#meantemp over time
EBS_mean_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
#SD temp over time
EBS_SD_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
#fishing over time
EBS_fishing_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
EBS_dissimilarity_temperature_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
  labs(x = "Mean Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
...
EBS_dissimilarity_temperature_mean_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_mean_scaled, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",])

summary(EBS_dissimilarity_temperature_mean_mod)

#for just ebs SD
EBS_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
EBS_dissimilarity_temperature_SD_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_SD, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",])

summary(EBS_dissimilarity_temperature_SD_mod)

#for just ebs fishing
#for just ebs SD
EBS_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",]) +
...
EBS_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "EBS_NA",])
...
#dissimilarity over time
NS_IBTS_dissimilarity_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Year",  y = "Average Bray Curtis Dissimilarity") +
...
#meantemp over time
NS_IBTS_mean_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Year",  y = "Mean Annual SST (˚C)") +
...
#SD temp over time
NS_IBTS_SD_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Year",  y = "SD of Mean Annual SST (˚C)") +
...
#fishing over time
NS_IBTS_fishing_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Year",  y = "Landings (tonnes)") +
...
#plotting linear models
#for just ebs mean temp
NS_IBTS_dissimilarity_temperature_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Mean Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
...
NS_IBTS_dissimilarity_temperature_mean_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_mean_scaled, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",])

summary(NS_IBTS_dissimilarity_temperature_mean_mod)

#for just ebs SD
NS_IBTS_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "SD of Mean Temperature",  y = "Average Bray Curtis Dissimilarity") +
...
NS_IBTS_dissimilarity_temperature_SD_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_SD, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",])

summary(NS_IBTS_dissimilarity_temperature_SD_mod)

#for just ebs fishing
#for just ebs SD
NS_IBTS_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",]) +
  labs(x = "Summed Landings (tonnes)",  y = "Average Bray Curtis Dissimilarity") +
...
NS_IBTS_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "NS-IBTS_NA",])
...
#dissimilarity over time
SCS_SUMMER_dissimilarity_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Year",  y = "Average Bray Curtis Dissimilarity") +
...
#meantemp over time
SCS_SUMMER_mean_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Year",  y = "Mean Annual SST (˚C)") +
...
#SD temp over time
SCS_SUMMER_SD_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Year",  y = "SD of Mean Annual SST (˚C)") +
...
#fishing over time
SCS_SUMMER_fishing_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Year",  y = "Landings (tonnes)") +
...
SCS_SUMMER_dissimilarity_temperature_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Mean Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
...
SCS_SUMMER_dissimilarity_temperature_mean_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_mean_scaled, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",])

summary(SCS_SUMMER_dissimilarity_temperature_mean_mod)

#for just ebs SD
SCS_SUMMER_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "SD of Mean Temperature",  y = "Average Bray Curtis Dissimilarity") +
...
SCS_SUMMER_dissimilarity_temperature_SD_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_SD, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",])

summary(SCS_SUMMER_dissimilarity_temperature_SD_mod)

#for just ebs fishing
#for just ebs SD
SCS_SUMMER_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",]) +
  labs(x = "Summed Landings (tonnes)",  y = "Average Bray Curtis Dissimilarity") +
...
SCS_SUMMER_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "SCS_SUMMER",])
...
#dissimilarity over time
IE_IGFS_NA_dissimilarity_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Year",  y = "Average Bray Curtis Dissimilarity") +
...
#meantemp over time
IE_IGFS_NA_mean_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Year",  y = "Mean Annual SST (˚C)") +
...
#SD temp over time
IE_IGFS_NA_SD_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Year",  y = "SD of Mean Annual SST (˚C)") +
...
#fishing over time
IE_IGFS_NA_fishing_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Year",  y = "Landings (tonnes)") +
...
#for just scs mean temp
IE_IGFS_NA_dissimilarity_temperature_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Mean Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
...
IE_IGFS_NA_dissimilarity_temperature_mean_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_mean_scaled, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",])

summary(IE_IGFS_NA_dissimilarity_temperature_mean_mod)

#for just ebs SD
IE_IGFS_NA_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "SD of Mean Temperature",  y = "Average Bray Curtis Dissimilarity") +
...
IE_IGFS_NA_dissimilarity_temperature_SD_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_SD, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",])

summary(IE_IGFS_NA_dissimilarity_temperature_SD_mod)

#for just ebs fishing
#for just ebs SD
IE_IGFS_NA_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",]) +
  labs(x = "Summed Landings (tonnes)",  y = "Average Bray Curtis Dissimilarity") +
...
IE_IGFS_NA_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "IE-IGFS_NA",])
...
#dissimilarity over time
GMEX_Fall_dissimilarity_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Year",  y = "Average Bray Curtis Dissimilarity") +
...
#meantemp over time
GMEX_Fall_mean_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Year",  y = "Mean Annual SST (˚C)") +
...
#SD temp over time
GMEX_Fall_SD_temp_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Year",  y = "SD of Mean Annual SST (˚C)") +
...
#fishing over time
GMEX_Fall_fishing_time <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Year",  y = "Landings (tonnes)") +
...
#for just scs mean temp
GMEX_Fall_dissimilarity_temperature_mean <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Mean Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
...
GMEX_Fall_dissimilarity_temperature_mean_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_mean_scaled, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",])

summary(GMEX_Fall_dissimilarity_temperature_mean_mod)

#for just ebs SD
GMEX_Fall_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "SD of Mean Temperature",  y = "Average Bray Curtis Dissimilarity") +
...
GMEX_Fall_dissimilarity_temperature_SD_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ sst_SD, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",])

summary(GMEX_Fall_dissimilarity_temperature_SD_mod)

#for just ebs fishing
#for just ebs SD
GMEX_Fall_dissimilarity_fishing <- ggplot(data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",]) +
  labs(x = "Summed Landings (tonnes)",  y = "Average Bray Curtis Dissimilarity") +
...
GMEX_Fall_dissimilarity_fishing_mod <- lm(bray_curtis_dissimilarity_balanced_mean ~ summed_tonnes, data = distances_dissimilarities_allyears.r.temp.fishing[survey_unit == "GMEX_Fall",])
