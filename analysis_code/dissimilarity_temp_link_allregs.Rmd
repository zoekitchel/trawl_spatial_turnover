...
(allreg_temperature_mean_v_difference_mean <- ggplot(data = distances_dissimilarities_allyears.year.models.temp) +
  labs(x = "Mean of Annual SST Scaled (˚C)",  y = "Avg Difference of Annual SST (˚C)") +
  geom_point(aes(x = sst_mean_scaled, y = sst_difference_mean, color = season_survey), alpha = 0.3) +
  geom_line(aes(x = sst_mean_scaled, y = sst_difference_mean, color = season_survey), stat="smooth", method = "lm") +
  scale_color_manual(values =  c("#5A5156","#E4E1E3","#F6222E","#FE00FA", 
  "#16FF32","#3283FE","#FEAF16","#B00068", 
  "#1CFFCE","#90AD1C","#2ED9FF","#DEA0FD", 
  "#AA0DFE","#F8A19F","#325A9B","#C4451C", 
...
allreg_temperature_mean_difference_mean_mod <- lmer(sst_difference_mean ~ sst_mean_scaled + (1|season_survey), data = distances_dissimilarities_allyears.year.models.temp)
...
ebs_dissimilarity_temperature_max <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "EBS_NA",]) +
  geom_smooth(aes(x = sst_max_scaled, y = mean_yearly_bray), method = "lm", se = F, color  = "#C4451C") +
  labs(x = "Scaled Maximum Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
  geom_point(aes(x = sst_max_scaled, y = mean_yearly_bray), color  = "#C4451C", alpha = 0.3) +
  theme_classic()
...
ebs_dissimilarity_temperature_max_mod <- lm(mean_yearly_bray ~ sst_max, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "EBS_NA",])
...
ebs_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "EBS_NA",]) +
  geom_smooth(aes(x = sst_SD_scaled, y = mean_yearly_bray), method = "gam", se = F, color  ="#C075A6") +
  labs(x = "Scaled Standard Deviation SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
  geom_point(aes(x = sst_SD_scaled, y = mean_yearly_bray), color  = "#C075A6", alpha = 0.3) +
  theme_classic()
...
ebs_dissimilarity_temperature_SD_mod <- lm(mean_yearly_bray ~ sst_SD, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "EBS_NA",])
...
What about scaled within a region for all regions?
...
allreg_dissimilarity_temperature_mean_scaled_mod <- lmer(mean_yearly_bray ~ sst_mean_scaled + (1 + sst_mean_scaled|season_survey), data = distances_dissimilarities_allyears.year.models.temp)
...
allreg_dissimilarity_temperature_min_scaled_mod <- lmer(mean_yearly_bray ~ sst_min_scaled + (1 + sst_min_scaled|season_survey), data = distances_dissimilarities_allyears.year.models.temp)
...
allreg_dissimilarity_temperature_max_scaled <- ggplot(data = distances_dissimilarities_allyears.year.models.temp) +
  ...
  "#822E1C","#B5EFB5","#7ED7D1","#1C7F93", 
  "#D85FF7","#683B79","#66B0FF","#3B00FB")) +
  geom_abline(aes(slope = 1.380e-02, intercept = 5.752e-01), method = "lm", se = F, color  = "black", size = 1) +
  theme_classic()
...
allreg_dissimilarity_temperature_max_scaled_mod <- lmer(mean_yearly_bray ~ sst_max_scaled + (1 + sst_max_scaled|season_survey), data = distances_dissimilarities_allyears.year.models.temp)

coefficients(allreg_dissimilarity_temperature_max_scaled_mod)
...
allreg_dissimilarity_temperature_SD_scaled <- ggplot(data = distances_dissimilarities_allyears.year.models.temp) +
  ...
  "#822E1C","#B5EFB5","#7ED7D1","#1C7F93", 
  "#D85FF7","#683B79","#66B0FF","#3B00FB")) +
  geom_abline(aes(slope = 0.04259, intercept = 0.58837), method = "lm", se = F, color  = "black", size = 1) +
  theme_classic()
...
allreg_dissimilarity_temperature_SD_scaled_mod <- lmer(mean_yearly_bray ~ sst_SD_scaled + (1 + sst_SD_scaled | season_survey), data = distances_dissimilarities_allyears.year.models.temp)

summary(allreg_dissimilarity_temperature_SD_scaled_mod)
```
Comparing temperature predictors
```{r compare temp predictors}
AICc(allreg_dissimilarity_temperature_SD_scaled_mod, allreg_dissimilarity_temperature_max_scaled_mod, allreg_dissimilarity_temperature_min_scaled_mod, allreg_dissimilarity_temperature_mean_scaled_mod)
...
SCS_SUMMER_dissimilarity_temperature_max <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "SCS_SUMMER",]) +
  labs(x = "Max Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
  geom_point(aes(x = sst_max, y = mean_yearly_bray), color = "#F7E1A0") +
  geom_line(aes(x = sst_max, y = mean_yearly_bray), color = "#F7E1A0", stat="smooth", method = "lm") +
  theme_classic()

SCS_SUMMER_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "SCS_SUMMER",]) +
...
SCS_dissimilarity_temperature_mean_mod <- lm(mean_yearly_bray ~ sst_mean, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "SCS_SUMMER",])

SCS_dissimilarity_temperature_max_mod <- lm(mean_yearly_bray ~ sst_max, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "SCS_SUMMER",])

SCS_dissimilarity_temperature_SD_mod <- lm(mean_yearly_bray ~ sst_SD, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "SCS_SUMMER",])
...
#for just scotian shelf
ICE_GFS_1_dissimilarity_temperature_max <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "ICE-GFS_1",]) +
  labs(x = "Max Annual SST (˚C)",  y = "Average Bray Curtis Dissimilarity") +
  geom_point(aes(x = sst_max, y = mean_yearly_bray), color = "#F7E1A0") +
  geom_line(aes(x = sst_max, y = mean_yearly_bray), color = "#F7E1A0", stat="smooth", method = "lm") +
  theme_classic()

ICE_GFS_1_dissimilarity_temperature_SD <- ggplot(data = distances_dissimilarities_allyears.year.models.temp[season_survey == "ICE-GFS_1",]) +
  labs(x = "Standard Deviation of Temp",  y = "Average Bray Curtis Dissimilarity") +
  geom_point(aes(x = sst_SD, y = mean_yearly_bray), color = "#F7E1A0") +
  geom_line(aes(x = sst_SD, y = mean_yearly_bray), color = "#F7E1A0", stat="smooth", method = "lm") +
  theme_classic()
...
ICE_dissimilarity_temperature_mean_mod <- lm(mean_yearly_bray ~ sst_mean, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "ICE-GFS_1",])

ICE_dissimilarity_temperature_max_mod <- lm(mean_yearly_bray ~ sst_max, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "ICE-GFS_1",])

ICE_dissimilarity_temperature_SD_mod <- lm(mean_yearly_bray ~ sst_SD, data = distances_dissimilarities_allyears.year.models.temp[season_survey == "ICE-GFS_1",])
