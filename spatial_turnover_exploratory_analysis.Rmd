...
for (i in 1:length(years)) {
  ...
  dissimilarities.l[reg1 == reg2, jaccard_dissimilarity := 1] #if they are the same value, assign jaccard_dissimilarity of one
...
plot(x=reduced_1_2$YEAR, y = reduced_1_2$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_1_2$jaccard_dissimilarity~reduced_1_2$YEAR))

reg_1_2.lm <- lm(reduced_1_2$jaccard_dissimilarity~reduced_1_2$YEAR)
...
plot(x=reduced_1_3$YEAR, y = reduced_1_3$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_1_3$jaccard_dissimilarity~reduced_1_3$YEAR))

reg_1_3.lm <- lm(reduced_1_2$jaccard_dissimilarity~reduced_1_3$YEAR)
...
plot(x=reduced_1_4$YEAR, y = reduced_1_4$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_1_4$jaccard_dissimilarity~reduced_1_4$YEAR))

reg_1_4.lm <- lm(reduced_1_4$jaccard_dissimilarity~reduced_1_4$YEAR)
...
reduced_3_2 <- distances_dissimilarities_allyears[reg1 == 3 & reg2 ==1,]
plot(x=reduced_1_3$YEAR, y = reduced_1_3$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_1_3$jaccard_dissimilarity~reduced_1_3$YEAR))

reg_1_3.lm <- lm(reduced_1_3$jaccard_dissimilarity~reduced_1_3$YEAR)
...
plot(x=reduced_4_2$YEAR, y = reduced_4_2$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_4_2$jaccard_dissimilarity~reduced_4_2$YEAR))

reg_4_2.lm <- lm(reduced_4_2$jaccard_dissimilarity~reduced_4_2$YEAR)
...
plot(x=reduced_3_4$YEAR, y = reduced_3_4$jaccard_dissimilarity, pch = 19, xlab = "Year", ylab = "Jaccard dissimilarity", ylim= c(0.2,0.9))
abline(lm(reduced_3_4$jaccard_dissimilarity~reduced_3_4$YEAR))

reg_3_4.lm <- lm(reduced_3_4$jaccard_dissimilarity~reduced_3_4$YEAR)
